            ...
            "steps": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "duration_sec": {"type": "integer", "minimum": 1, "description": "Step duration in seconds."},
                        "type": {
                            "type": "string",
                        ...
                        "target": {
                            "type": "string",
                            "enum": ["HR", "PACE", "POWER"],
                            "description": "Target metric; omit to auto-detect from the supplied bounds.",
                        },
                        "hr_min": {"type": "integer", "minimum": 1, "description": "Minimum heart rate in BPM."},
                        "hr_max": {"type": "integer", "minimum": 1, "description": "Maximum heart rate in BPM."},
                        "pace_min": {"type": ["string", "number"], "description": "Slow bound: min/km as M:SS or speed in m/s."},
                        "pace_max": {"type": ["string", "number"], "description": "Fast bound: min/km as M:SS or speed in m/s."},
                        "power_min": {"type": "integer", "minimum": 1, "description": "Minimum power in watts."},
                        "power_max": {"type": "integer", "minimum": 1, "description": "Maximum power in watts."},
                        "power_pct_min": {"type": "number", "minimum": 1, "description": "Minimum power as percent of FTP."},
                        "power_pct_max": {"type": "number", "minimum": 1, "description": "Maximum power as percent of FTP."},
                    },
                    "required": ["name", "duration_sec", "type"],
                },
            },
        },
